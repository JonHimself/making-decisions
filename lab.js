...
if (amysAge >= brittanisAge) {
  ...
  console.log('These two are the same old');
} else {
...
if (amysBirthYear === brittanisAge) {
  ...
  console.log('Any and BRittani were not born in the same year');
}
...
// Use an if statement to check the length of the 'myFavoriteNumbers' array. If it's less than 7, log 'There are not enough elements in this array' to the console. If the length is more than 7, reassign the value of 'someNum' to the value of the 7th element in the array. 
...
switch (letterGrade) {
  ...
  case 'D':
    ...
    break;
  case 'F':
    console.log('Return your child please');
    break;
  default:
...
/* The famous FizzBuzz, Devmountain style!
  ...
  If the number is divisible by 5 & 3, console.log 'Devmountain'. If the number is not divisible by 5 or 3, console.log the number itself. Hint: Look up the modulo operator.
